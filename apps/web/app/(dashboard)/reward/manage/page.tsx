                      ...
                      <td className="px-6 py-4 text-right font-medium">
                        <TableActionMenu
                          items={[
                            ...
                            { label: 'Hapus', onClick: () => setDeleteTarget({ type: 'catalog', id: r.id, name: r.name }), variant: 'danger' },
                          ]}
                        />
                      </td>
                    </tr>
                      ...
                      <td className="px-6 py-4 text-right font-medium">
                        <TableActionMenu
                          items={[
                            ...
                            { label: 'Hapus', onClick: () => setDeleteTarget({ type: 'hashtag', id: h.id, name: h.tag }), variant: 'danger' },
                          ]}
                        />
                      </td>
                    </tr>
