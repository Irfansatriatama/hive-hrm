export const DEFAULT_SYSTEM_MODULES = [
  ...
  { key: 'visitor', name: 'Visitor System Registration', description: 'Badge generator forms, check-in overlays, and historical logs.', icon: 'user-check', isCore: false, sortOrder: 15 },
