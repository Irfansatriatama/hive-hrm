...
class AnnouncementPreview extends StatelessWidget {
  ...
  const AnnouncementPreview({super.key, required this.announcements});
      ...
      children: [
        for (var i = 0; i < announcements.length; i++) ...[
          ...
          _AnnouncementTile(
            ...
            relativeTime: _relativeTime(context, announcements[i].createdAt),
    ...
    return HiveCard(
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              if (!announcement.isRead) ...[
                Container(
                  width: AppTheme.sm,
                  height: AppTheme.sm,
                  margin: const EdgeInsets.only(top: AppTheme.xs, right: AppTheme.sm),
          ...
          const SizedBox(height: AppTheme.xs),
          Text(relativeTime, style: AppTextStyle.caption),
        ],
      ),
    );
  }
